  ...
  return (
    <>
      ...
      <div className="fixed bottom-16 left-0 right-0 z-40">
        {trackId ? (
          /* Spotify embed as the sole mini-player when a track is selected */
          <div className="px-2">
          ...
          /* Custom bar when no track is playing */
          <div className="glass border-t border-border cursor-pointer" onClick={() => isConnected ? setExpanded(true) : connect()}>
